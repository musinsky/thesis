...
Urýchľovanie ťažkých iónov sa stalo možným v~CERNe a
...
% \section{Dynamika zrážok ťažkých iónov.}
% Na obrázku 2.2 [4] môžeme vidieť schematické znázornenie
% zrážky dvoch ťažkých iónových jadier. Pre štúdium
% týchto zrážok je užitočné zaviesť premennú
% rapidita, definovanú ako
% \begin{center}{\large $Y=\frac{1}{2}\ln(\frac{E^{*}+p_{L}^{*}}
% {E^{*}-p_{L}^{*}})$}
% \end{center}
% kde $E^{*}$ je energia v~CMS a $p_{L}^{*}$ je pozdlžná hybnosť
...
% hmotnosti.
%
% V~hlboko nepružnej zrážke veľké množstvo energie a
% hmoty môže byť  pretransformované medzi zrážajúcimi sa
% jadrami. Jadrá môžu byť taktiež spojené na určitý
% čas, ale po zrážke binárny charakter systému ostáva. Pri
% enrgiách nad touto binárnou energiou sa systém môže
% roztrieštiť. Pre centrálne symetrické zrážky, tento
% systém môže utrpieť totálnu explóziu. Pre okrajové
% zrážky je často použity tzv. participant-spectator
% (účastník-divák) model. Nukleóny, ktoré vďaka
...
% fireball, ktorý je bohatý na baryóny a tiež obsahuje veľký
...
% fireball bude mať dostatočnú teplotu a hustotu. Pritom energie
% zrážky sa zvyšuje so zvyšovaním nukleonového
% čísla A.
%
% Akcelerácia ťažkých iónov sa stala možnou v~CERNe a
% Brookhavene v~1986.  Urychľované boli ióny, kde pomer
% protonového a nukleonového čísla bol Z/A=1/2. V~Brookhavene to
% boli kyslíkove a kremíkove zväzky urýchlené na 14.5 Gev/c
% na nukleón, zatiaľ čo v~CERNe kyslíkove a sírove
...
%sa nakoniec prestanú zrážať a uletia, tieto potom môžme
potom môžeme
...
Zrážky ťažkých jadier nám prinajlepšom
...
% môžu  prispievať k~štúdiu QGP. Dileptóny sú
