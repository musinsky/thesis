  {
    ...
    //=========  (Thu Feb 11 14:18:15 2010) by ROOT version5.26/00b
    ...
    TPad *pad = new TPad("pad", "Detectors display",0,-0,0.9964413,0.9974359);
    pad->Draw();
    pad->cd();
    ...
    line->SetLineWidth(3);
    line->Draw();
    TArrow *arrow = new TArrow(8.15,4.1,8.968085,1.351508,0.02,">");
    arrow->SetFillColor(1);
    arrow->SetFillStyle(1001);
    arrow->SetAngle(33);
    arrow->Draw();
    arrow = new TArrow(8.70,4.1,10.23191,-1.839553,0.02,">");
    arrow->SetFillColor(1);
    arrow->SetFillStyle(1001);
    arrow->SetAngle(33);
    arrow->Draw();
    TLatex *   tex = new TLatex(7.6,4.5,"track(s)-candidate");
    tex->SetTextAlign(22);
    tex->SetTextFont(132);
    ...
    printTeX("event_104_run126_full");
    gSystem->Exec("pdfcrop --margins '5 40 5 30' event_104_run126_full.pdf event_104_run126.pdf");
  }
